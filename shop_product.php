<?php include("mainhead.php"); ?>
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    ...
    <?php include("header.php");?>
      ...
      ?>
      <div class="main">
        <section class="module bg-dark-60 shop-page-header" data-background="http://localhost/Titan-Project/adminside/Adminside_Titan_shoppers/php/Photoes/Shop_Banners/<?php echo $shop_banners['img_Banners']; ?>">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt"><?php echo $shop_banners['Big_hedline']; ?></h2>
                <div class="module-subtitle font-serif"><?php echo $shop_banners['Sub_message']; ?></div>
              </div>
            </div>
          </div>
        </section>
        <section class="module-small">
          ...
          <div class="container">
            ...
            <div class="row">
                    ...
                    {
                      ?>
                      <div class="alert alert-success" align="center" role="alert"><h5 style="align-items: center; justify-content: center; display: flex;"><strong>Hey!</strong> <?php  echo $_SESSION['add']; ?></h5></div>
                      <?php
            ...
            <div class="row">
                      ...
                      {
                        ?>
                        <div class="alert alert-success" align="center" role="alert"><h5 style="align-items: center; justify-content: center; display: flex;"><strong>Hey!</strong> <?php  echo $_SESSION['added']; ?></h5></div>
                        <?php
            ...
            <div  class="row">
                            ...
                            {
                              ?>
                              <div class="alert alert-danger" align="center" role="alert"><h5 style="align-items: center; justify-content: center; display: flex;"><strong>Hey!</strong> <?php  echo $_SESSION['alredyadd']; ?></h5></div>
                              <?php
                ...
                <div  class="col-sm-12 col-xl-8 col-md-6">
                  ...
                  <form role="form">
                    <div class="search-box">
                      <input class="form-control" id="searchInput" onkeyup="search()" type="text" placeholder="Search products..."/>
        ...
        <?php
            $conn=mysqli_connect("localhost","root","","titanshoppers");
            //$sql="SELECT * FROM shopproduct WHERE gender=".$_REQUEST['productid'];
      ...
      <div class="col-sm-6 col-md-3 col-lg-3 blogBox moreBox" style="display: none;">
        <div class="shop-item productt">
          <div class="shop-item-image">
            <img name="product_img" style="height: 50vh; width:43vh ; object-fit: cover;"
          ...
          if (isset($_SESSION['user_name'])) {
            ...
            <div class="row mb-20">
              <div class="col-sm-12">
                <button class="btn btn-lg btn-block btn-round btn-b" name="Add_to_cart">
                  Add To Cart
                </button>
              </div>
            </div>
...
?>
            ...
            <div class="row">
              <div id="loadMore" class="col-sm-12 align-center"><button class="seeallpro btn btn-b btn-round" href="#">See all products</button> </div>
            </div>
          </div>
        </section>
