        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="page-header">
              <h3 class="page-title">Male Product </h3>
            ...
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Male Product</h4>
                    ...
                    <div class="table-responsive">
                      <table class="table text-center">
                        <div  class="row center" >
                            ...
                            if (isset($_SESSION['Mproductid'])) 
                            {
                              ?>
                              <div align="center" class="alert alert-success" role="alert"><h5 style="align-items: center; justify-content: center; display: flex;"><strong>Hey!</strong> <?php  echo $_SESSION['Mproductid']; ?></h5></div>
                              <?php
                             
                              unset($_SESSION['Mproductid']);
                            }
                        ...
                        <?php
                          ...
                          $sql="SELECT * FROM shopproduct WHERE gender='M' ORDER BY productid ";
                        ...
                        <tbody>
                          <tr style="display: none;" class="blogBox moreBox">
                            ...
                            <td><a href="Delete/Male_product_delete.php?productid=<?php echo $row['productid'];?>"><button type="button" class="btn btn-danger btn-md">Delete</button></td>
                            <td><?php echo $row['productid']; ?></td>
                          </tr>
                        </tbody>
                        <?php
