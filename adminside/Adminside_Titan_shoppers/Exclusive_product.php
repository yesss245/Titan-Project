        ...
        <div class="main-panel">
          <div class="content-wrapper">
                ...
                <div class="col-xl-6 col-sm-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-9">
                          <div class="d-flex align-items-center align-self-start">
                            <a style="text-decoration:none; color:#fff;" href="http://localhost/Titan-Project/adminside/Adminside_Titan_shoppers/All_product.<?php  ?>">
                      ...
                      $sql1="SELECT productid FROM shopproduct ORDER BY productid";
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-9">
                          <div class="d-flex align-items-center align-self-start">
                            <a style="text-decoration:none; color:#fff;" href="Exclusive_product.php">
                            <h3 class="mb-0">Total Exclusive Product</h3>
                           <!--  <p class="text-success ml-2 mb-0 font-weight-medium">+11%</p> -->
                         </a>
                          </div>
                        </div>
            ...
            <div class="page-header">
              <h3 class="page-title">Exclusive Product </h3>
                    ...
                    <div class="table-responsive">
                      <table class="table text-center">
                        ...
                        <?php
                          ...
                          $sql="SELECT * FROM shopproduct WHERE exclusive_product='1' ORDER BY productid";
                        ...
                        <tbody>
                          <tr style="display: none;" class="blogBox moreBox">
                            ...
                            <td><a href="php/Photoes/<?php echo $row['img'];?>"><img  style="border-radius: 50%; object-fit: cover;" src="php/Photoes/<?php echo $row['productname'].$pro_img[0];?>"></a></td>
