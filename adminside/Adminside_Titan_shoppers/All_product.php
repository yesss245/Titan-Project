                    ...
                    <div class="table-responsive">
                      <table class="table text-center" id="myTable">
                        <div  class="row center" >
                            ...
                            {
                              ?>
                              <div align="center" class="alert alert-success" role="alert"><h5 style="align-items: center; justify-content: center; display: flex;"><strong>Hey!</strong> <?php  echo $_SESSION['productid']; ?></h5></div>
                              <?php
                        ...
                        <?php
                          ...
                          $sql="SELECT * FROM shopproduct ORDER BY productid";
                          $result=mysqli_query($conn,$sql);
                          if ($result) 
                            {
                        ...
                        <tbody>
                          <tr id="tr" style="display: none;" class="blogBox moreBox">
                            ...
                            <td><a href="php/Photoes/<?php echo $row['img'];?>">
                               <img  style="border-radius: 50%; object-fit: cover;" src="php/Photoes/<?php echo $row['productname'].$pro_img[0];?>"></a></td>
                            ...
                            <td><textarea style="background-color:#191c24; border: none; color:#6c7293;" rows="3"><?php echo $row['discription']; ?></textarea></td>
                                  <?php
                                    $sql3 = "select count(Product_id)from rating where Product_id = '$row[productid]'";
                                    $creview = mysqli_query($conn,$sql3);
                                    $reviewcount = mysqli_fetch_array($creview);
                                  ?>
                            <td><a style="text-decoration:none; color:#6c7293;" href="single_product_view.php?Review=<?php echo $row['productid']; ?>"><?php echo "$reviewcount[0]"; ?></a></td>
                            <td>
                            ...
                            <td><a href="Delete/All_product_delete.php?productid=<?php echo $row['productid'];?>"><button type="button" class="btn btn-danger btn-md">Delete</button></td>
