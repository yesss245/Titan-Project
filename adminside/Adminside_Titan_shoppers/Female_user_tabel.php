                    ...
                    <div class="table-responsive">
                      <table class="table" >
                        ...
                        <?php
                          ...
                          $sql="SELECT * FROM login WHERE Gender='F'";
                          $result=mysqli_query($conn,$sql);
                          if ($result) 
                            {
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><a href="php/Photoes/UserProfile/<?php echo $row['img'];?>"><img style="" class="r" style=" height: 10vh; width:auto; border-radius: 50%; object-fit:cover;" src="php/Photoes/UserProfile/<?php echo $row['img'];?>"></a></td>
                            ...
                            <td><a href="Delete/user_delete.php?userpid='<?php echo $row['userid'];?>'"><button type="button" class="btn btn-danger btn-md">Delete</button></td>
                          </tr>
                        </tbody>
                        <?php
                                  }
