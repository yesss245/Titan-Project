...
session_start();
	...
	if (!empty($ptitle)) 
		...
		if (mysqli_query($conn,$sql)) 
		{
			...
			header("location:http://localhost/Titan-Project/adminside/Adminside_Titan_shoppers/Add_Latest_Product.php");
		}
		else
		{
			$_SESSION['LatestProductnot'] = "Latest product Not insert !!!";
