                    ...
                    <div class="table-responsive">
                      <table class="table text-center">
                        ...
                        <?php
                          ...
                          $sql="SELECT * FROM shopproduct WHERE productcategoryid='2' ORDER BY productid";
                        ...
                        <tbody>
                          <tr style="display: none;" class="blogBox moreBox">
                            ...
                            <td><a href="php/Photoes/<?php echo $row['img'];?>"><img  style="border-radius: 50%; object-fit: cover;" src="php/Photoes/<?php echo $row['img'];?>"></a></td>
